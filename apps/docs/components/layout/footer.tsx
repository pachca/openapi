...
function PrevButton({ item }: { item: NavigationItem }) {
  ...
  return (
    <Link
      href={item.href}
      onClick={handleClick}
      className="flex flex-col gap-1 p-4 rounded-xl border border-glass-border bg-glass backdrop-blur-md hover:bg-glass-hover transition-all duration-200 group"
    >
