      ...
      >
        {otherSections.map((section, idx) => {
          ...
          return (
            ...
            >
              <Accordion.Header>
                <Accordion.Trigger className="flex gap-1.5 w-full items-center justify-between px-2.5 py-1.5 text-[14px] leading-[1.4] rounded-lg text-text-primary hover:bg-background-tertiary transition-colors duration-200 font-medium tracking-tight group cursor-pointer outline-none group">
