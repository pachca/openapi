---
title: Модели
description: "Справочник моделей данных Pachca API: свойства и методы, возвращающие каждый объект — сотрудники, чаты, сообщения, черновики, задачи, теги, вебхуки и другие сущности"
...
<Info>Методы [Получение подписи, ключа и других параметров](POST /uploads), [Загрузка файла](POST /direct_url) и [Скачивание файла](GET /files/{id}) не возвращают модели данных: первые два отвечают параметрами загрузки и пустым телом, третий — самим файлом.</Info>
...
<ModelSchema name="CompanyBotResponse" />
