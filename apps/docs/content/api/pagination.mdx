...
<CodeBlock language="json" title="Пример ответа с пагинацией">
{`{
  "data": [...],
  "meta": {
    "paginate": {
...
<CodeBlock language="javascript" title="Node.js: обход всех записей">
...
<CodeBlock language="python" title="Python: обход всех записей">
{`import requests
