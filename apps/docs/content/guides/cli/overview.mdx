...
<CardGroup columns={2}>
  <Card title="Авторизация" href="/guides/cli/authentication">Профили, приоритет источников токена, headless-режим для CI и агентов</Card>
  <Card title="Вывод" href="/guides/cli/output">Форматы (table, json, yaml, csv), колонки, пайпы, пагинация</Card>
  <Card title="Флаги и скрипты" href="/guides/cli/scripting">Глобальные флаги, exit codes, таксономия ошибок, переменные окружения</Card>
  ...
  <Card title="Прямые запросы" href="/guides/cli/api-requests">Прямой HTTP-запрос к любому методу и встроенный справочник по API в терминале</Card>
  <Card title="Справочник команд" href="/guides/cli/commands">Все команды, параметры каждой — по клику</Card>
</CardGroup>
