...
<CardGroup columns={2}>
  <Card icon="Library" title="Команды" href="/guides/cli/commands">каждый метод API — типизированная команда; полный справочник</Card>
  ...
  <Card icon="Terminal" title="Прямые запросы" href="/guides/cli/api-requests">вспомогательный `pachca api`, когда команды не хватает</Card>
</CardGroup>
