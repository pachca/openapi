---
title: Скрипты и CI
description: "Pachca CLI в скриптах: форматы вывода, пайпы, пагинация, глобальные флаги, kebab-case, dry-run, exit codes, таксономия ошибок, переменные окружения, неинтерактивный режим."
---
