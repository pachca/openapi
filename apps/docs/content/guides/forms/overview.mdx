---
title: Обзор
description: "Модальные формы ботов в Пачке: поля ввода, списки, даты и кнопки, жизненный цикл представления — от нажатия кнопки до валидации и закрытия модального окна"
related:
  - /guides/forms/blocks
