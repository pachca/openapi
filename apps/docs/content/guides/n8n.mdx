---
title: n8n
description: Как настроить автоматизации в Пачке через платформу n8n без программирования
---
...
<ImageCard src="/images/n8n/n8n-interface.avif" alt="Интерфейс n8n с визуальным редактором workflow" caption="Визуальный редактор n8n" />

## Настройка

<Steps>
  <Step title="Установка n8n">
    <Warning>Расширение Пачки доступно пока только в Beta. Это значит, что его нет в веб-версии n8n и для пользования нужно предварительно развернуть на собственном сервере коробочную версию n8n.</Warning>
    ...
    **С помощью Docker**
    ...
    <ImageCard src="/images/n8n/owner-account.avif" alt="Настройка аккаунта владельца n8n" caption="Настройка Owner Account" />
  </Step>
  <Step title="Настройка расширения Пачки для n8n">
    ...
    <ImageCard src="/images/n8n/community-nodes.avif" alt="Установка расширения Пачки через Community nodes" caption="Установка через Community nodes" />
  </Step>
  <Step title="Создание Credentials">
    ...
    <ImageCard src="/images/n8n/credentials.avif" alt="Создание Credentials для Пачки в n8n" caption="Настройка Pachca API Credentials" />
  </Step>
  <Step title="Создание Workflow">
    ...
    <ImageCard src="/images/n8n/workflow-editor.avif" alt="Визуальный редактор workflow в n8n" caption="Редактор workflow" />
    ...
    <ImageCard src="/images/n8n/workflow-example.avif" alt="Пример workflow с отправкой сообщения" caption="Пример отправки сообщения" />
...
<Warning>Обратите внимание, что некоторые действия возможны только с токеном Владельца/Администратора.</Warning>
