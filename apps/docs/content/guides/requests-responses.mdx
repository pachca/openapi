...
Импортируйте готовую коллекцию для тестирования методов API локально:

<CardGroup columns={2}>
  <Card title="Postman" icon="ArrowDownToLine" href="/pachca.postman_collection.json">
    Скачайте коллекцию со всеми методами. Запросы выполняются локально с вашего компьютера.
  </Card>
  <Card title="Bruno" icon="ArrowDownToLine" href="/pachca.postman_collection.json">
    Open-source альтернатива Postman. Импортируйте тот же файл: File → Import → Postman Collection.
  </Card>
</CardGroup>
