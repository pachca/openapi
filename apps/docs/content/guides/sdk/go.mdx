---
title: Go
description: "Типизированный клиент для Pachca API на Go: синхронный, с context.Context, автопагинацией и обработкой retry. Установка через go get, требуется Go 1.24+"
related:
...
<CardRow>
  <Card compact icon="Package" title="github.com/pachca/openapi/sdk/go" href="https://pkg.go.dev/github.com/pachca/openapi/sdk/go/generated">pkg.go.dev</Card>
</CardRow>
...
<ApiCodeExample lang="go" showInit={false} operations={[
