---
title: Обзор
description: "Типизированные SDK для Pachca API на TypeScript, Python, Go, Kotlin, Swift и C#: автодополнение, retry и пагинация. Или свой клиент через OpenAPI-генератор"
related:
  - /api/authorization
  - /api/pagination
  - { path: /guides/cli/overview, title: CLI }
---
...
<CardGroup>
  ...
  <Card compact title="C#" icon="FileText" href="/guides/sdk/csharp">NuGet · async/await · HttpClient</Card>
</CardGroup>
...
<CardRow>
  <Card compact icon="Package" title="@pachca/generator" href="https://www.npmjs.com/package/@pachca/generator">npm</Card>
</CardRow>
...
<ApiCodeExample operationId="ProfileOperations_getProfile" title="Получение профиля" show="request" langs={["typescript", "python", "go", "kotlin", "swift", "csharp"]} />
