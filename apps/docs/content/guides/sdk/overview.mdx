---
title: Обзор
description: Типизированные клиентские библиотеки и генератор для Pachca API
---
...
<CardGroup>
  ...
  <Card compact title="CSharp" icon="FileText" href="/guides/sdk/csharp">NuGet · async/await · HttpClient</Card>
</CardGroup>
