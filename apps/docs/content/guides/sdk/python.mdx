---
title: Python
description: "Асинхронный типизированный клиент для Pachca API на Python: httpx, type hints, dataclass-модели, автопагинация и retry. PyPI-пакет, требуется Python 3.10+"
related:
  - { path: /guides/sdk/overview, title: SDK }
  - /api/authorization
  - /api/pagination
---
