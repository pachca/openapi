...
description: "Исходящие вебхуки в Пачке: уведомления о событиях пространства (сообщения, реакции, участники) в реальном времени, подпись для проверки подлинности запроса"
---
