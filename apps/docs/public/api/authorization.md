...
- **Токен бота** — скоупы можно выбрать при создании или редактировании бота (параметр `scopes` в методах [Новый бот](/api/bots/create) и [Редактирование бота](/api/bots/update)). Если скоупы не указаны, бот получает набор по умолчанию.
