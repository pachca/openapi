...
- `data: object` (required) — Параметры созданного бота
  ...
  - `access_token: string` (required) — Токен доступа бота. Возвращается при создании бота и при ротации токена. Пример: `"bm90X2FfcmVhbF90b2tlbg"`
