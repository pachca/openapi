...
```bash
pachca api bots 01KAJZ2XDSS2S3DSW9EXJZ0TBV \
  --json \
...
```javascript
const response = await fetch('https://api.pachca.com/api/shared/v1/webhooks/events/01KAJZ2XDSS2S3DSW9EXJZ0TBV', {
  method: 'DELETE',
  headers: {
...
response = requests.delete(
    'https://api.pachca.com/api/shared/v1/webhooks/events/01KAJZ2XDSS2S3DSW9EXJZ0TBV',
    headers=headers
)
...
const options = {
    ...
    port: 443,
    path: '/api/shared/v1/webhooks/events/01KAJZ2XDSS2S3DSW9EXJZ0TBV',
    method: 'DELETE',
    headers: {
        'Authorization': 'Bearer YOUR_ACCESS_TOKEN'
    }
...
uri = URI('https://api.pachca.com/api/shared/v1/webhooks/events/01KAJZ2XDSS2S3DSW9EXJZ0TBV')
...
curl_setopt_array($curl, [
    CURLOPT_URL => 'https://api.pachca.com/api/shared/v1/webhooks/events/01KAJZ2XDSS2S3DSW9EXJZ0TBV',
