...
> Краткое содержание: Метод позволяет боту самостоятельно изменить URL своего исходящего вебхука своим же токеном — без участия администратора и без знания собственного id
