...
```javascript
const response = await fetch('https://api.pachca.com/api/shared/v1/chats/334/archive', {
  method: 'PUT',
  headers: {
...
response = requests.put(
    'https://api.pachca.com/api/shared/v1/chats/334/archive',
    headers=headers
)
...
const options = {
    ...
    port: 443,
    path: '/api/shared/v1/chats/334/archive',
    method: 'PUT',
    headers: {
        'Authorization': 'Bearer YOUR_ACCESS_TOKEN'
    }
...
uri = URI('https://api.pachca.com/api/shared/v1/chats/334/archive')
...
curl_setopt_array($curl, [
    CURLOPT_URL => 'https://api.pachca.com/api/shared/v1/chats/334/archive',
