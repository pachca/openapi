...
> Краткое содержание: В ответ на запрос сервер вернёт 302 Found с заголовком Location, содержащим временную ссылку на скачивание файла
