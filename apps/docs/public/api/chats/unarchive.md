...
> Краткое содержание: Возвращает беседу или канал из архива: чат снова появляется в списках, и в него снова можно писать.
