...
Схема дополнительных полей пространства: идентификатор, название и тип каждого. Значения полей конкретного сотрудника приходят в его карточке, а идентификаторы отсюда нужны, чтобы эти значения задавать.
