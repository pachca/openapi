> Расположение: Методы API → Дополнительные поля
> Краткое содержание: Схема дополнительных полей пространства: идентификатор, название и тип каждого
