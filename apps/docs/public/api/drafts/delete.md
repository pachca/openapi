...
> Краткое содержание: Убирает свой черновик насовсем: восстановить его нельзя, вложения удаляются вместе с ним
...
```bash
curl -X DELETE "https://api.pachca.com/api/shared/v1/drafts/4821" \
