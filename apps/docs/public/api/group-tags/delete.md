...
> Краткое содержание: Убирает тег из пространства: он снимается со всех сотрудников и отвязывается от всех чатов.
...
Из чатов при этом никто не выходит. Сотрудники, которых тег привёл в беседу или канал, остаются там обычными участниками, и дальше их состав тегом уже не поддерживается. Чтобы вывести их из конкретного чата, пользуйтесь методом [Исключение тега](/api/members/remove-group-tag) до удаления самого тега.
