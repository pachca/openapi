...
> Краткое содержание: Кто состоит в теге
...
Состав тега меняют в карточке сотрудника — [Редактирование сотрудника](/api/users/update) с полем `list_tags`, по одному сотруднику за раз.

Мульти-гостю метод отвечает `403`: список сотрудников пространства ему закрыт, как и в интерфейсе.
