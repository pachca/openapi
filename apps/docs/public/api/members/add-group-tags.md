...
> Краткое содержание: Привязывает теги к беседе или каналу, чтобы состав чата поддерживался сам.
...
Привязать тег может участник закрытой беседы и любой сотрудник пространства в открытом чате, а отцепить — только владелец или администратор чата методом [Исключение тега](/api/members/remove-group-tag).
