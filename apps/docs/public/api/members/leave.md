...
> Краткое содержание: Владелец токена выходит из беседы, канала или треда сам
...
Вернуться в открытый чат можно самому, в закрытый — только если кто-то из участников добавит обратно. Другого сотрудника выводит [Исключение пользователя](/api/members/remove).
