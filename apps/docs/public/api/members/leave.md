...
```javascript
const response = await fetch('https://api.pachca.com/api/shared/v1/chats/334/leave', {
  method: 'DELETE',
  headers: {
...
response = requests.delete(
    'https://api.pachca.com/api/shared/v1/chats/334/leave',
    headers=headers
)
...
const options = {
    ...
    port: 443,
    path: '/api/shared/v1/chats/334/leave',
    method: 'DELETE',
    headers: {
        'Authorization': 'Bearer YOUR_ACCESS_TOKEN'
    }
...
uri = URI('https://api.pachca.com/api/shared/v1/chats/334/leave')
...
curl_setopt_array($curl, [
    CURLOPT_URL => 'https://api.pachca.com/api/shared/v1/chats/334/leave',
