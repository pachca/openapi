...
```javascript
const response = await fetch('https://api.pachca.com/api/shared/v1/chats/334/members?role=all&limit=1&cursor=eyJpZCI6MTAsImRpciI6ImFzYyJ9', {
  method: 'GET',
  headers: {
...
response = requests.get(
    'https://api.pachca.com/api/shared/v1/chats/334/members',
    params=params,
    headers=headers
)
...
const options = {
    ...
    port: 443,
    path: '/api/shared/v1/chats/334/members?role=all&limit=1&cursor=eyJpZCI6MTAsImRpciI6ImFzYyJ9',
    method: 'GET',
    headers: {
        'Authorization': 'Bearer YOUR_ACCESS_TOKEN'
    }
...
uri = URI('https://api.pachca.com/api/shared/v1/chats/334/members')
params = {
  'role' => 'all',
  'limit' => 1,
  'cursor' => 'eyJpZCI6MTAsImRpciI6ImFzYyJ9',
...
$params = ['role' => 'all', 'limit' => 1, 'cursor' => 'eyJpZCI6MTAsImRpciI6ImFzYyJ9'];
$curl = curl_init();

curl_setopt_array($curl, [
    CURLOPT_URL => 'https://api.pachca.com/api/shared/v1/chats/334/members?' . http_build_query($params)',
