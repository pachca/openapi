...
- `id` (integer, **обязательный**): Идентификатор чата
  - Пример: `334`
- `tag_id` (integer, **обязательный**): Идентификатор тега
  - Пример: `86`
...
```javascript
const response = await fetch('https://api.pachca.com/api/shared/v1/chats/334/group_tags/86', {
  method: 'DELETE',
  headers: {
...
response = requests.delete(
    'https://api.pachca.com/api/shared/v1/chats/334/group_tags/86',
    headers=headers
)
...
const options = {
    ...
    port: 443,
    path: '/api/shared/v1/chats/334/group_tags/86',
    method: 'DELETE',
    headers: {
        'Authorization': 'Bearer YOUR_ACCESS_TOKEN'
    }
...
uri = URI('https://api.pachca.com/api/shared/v1/chats/334/group_tags/86')
...
curl_setopt_array($curl, [
    CURLOPT_URL => 'https://api.pachca.com/api/shared/v1/chats/334/group_tags/86',
