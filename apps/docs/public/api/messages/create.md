...
- `message: object` (required) — Собранный объект параметров создаваемого сообщения
  ...
  - `files: array of object` — Прикрепляемые файлы
    - `key: string` (required, max length: 1000) — Путь к файлу, полученный в результате [загрузки файла](/api/files/direct-url). Пример: `"attaches/files/93746/e354fd79-4f3e-4b5a-9c8d-1a2b3c4d5e6f/logo.png"`
