...
> Краткое содержание: Закрепляет сообщение в шапке беседы или канала, где его видят все участники
...
В треде закреплять нечего: метод работает только в обычных чатах. Уже закреплённое сообщение отвечает `409`, а удалённое — `422`.
