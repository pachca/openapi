...
Поведение полей `meta.paginate` для типичных сценариев пагинации (на примере метода [Список чатов](/api/chats/list) с DESC-сортировкой):
