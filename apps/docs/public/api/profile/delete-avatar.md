...
> Краткое содержание: Убирает аватар владельца токена, дальше в интерфейсе показываются инициалы
