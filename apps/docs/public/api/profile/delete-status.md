...
> Краткое содержание: Снимает статус с владельца токена вместе с режимом «Нет на месте» и его текстом
