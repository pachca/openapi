...
> Краткое содержание: Статус владельца токена: эмодзи, подпись, срок и режим «Нет на месте».
