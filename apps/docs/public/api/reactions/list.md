...
> Краткое содержание: Все реакции на сообщении и кто их поставил: в каждой записи приходит userid и сам символ.
