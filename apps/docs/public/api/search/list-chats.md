...
> Краткое содержание: Метод ищет по названиям, а не по содержанию
...
Метод ищет по названиям, а не по содержанию. Если нужно найти, где что-то обсуждали или о чём договорились, это [Поиск сообщений](/api/search/list-messages): тема разговора редко совпадает с названием чата.

Число в `meta.total` считается до проверки доступа, поэтому оно может оказаться больше, чем реально отданных чатов.
