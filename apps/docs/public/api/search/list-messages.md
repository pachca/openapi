...
> Краткое содержание: Ищет по тексту сообщений и по именам вложенных файлов, но только в чатах, где владелец токена состоит
