...
> Краткое содержание: Напоминание вместе с его автором, ответственными и чатом, к которому оно привязано.
