...
```javascript
const response = await fetch('https://api.pachca.com/api/shared/v1/threads/265142', {
  method: 'GET',
  headers: {
...
response = requests.get(
    'https://api.pachca.com/api/shared/v1/threads/265142',
    headers=headers
)
...
const options = {
    ...
    port: 443,
    path: '/api/shared/v1/threads/265142',
    method: 'GET',
    headers: {
        'Authorization': 'Bearer YOUR_ACCESS_TOKEN'
    }
...
uri = URI('https://api.pachca.com/api/shared/v1/threads/265142')
...
curl_setopt_array($curl, [
    CURLOPT_URL => 'https://api.pachca.com/api/shared/v1/threads/265142',
