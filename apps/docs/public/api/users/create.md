...
> Краткое содержание: Заводит сотрудника в пространстве и отправляет ему приглашение на почту
