...
> Краткое содержание: Убирает сотрудника из пространства
...
Если сотрудник уходит в отпуск или увольнение ещё не финальное, пользуйтесь методом [Редактирование сотрудника](/api/users/update) с `suspended: true`. Приостановка обратима и сохраняет чаты, теги и задачи.
