...
> Краткое содержание: Убирает аватар другому сотруднику, дальше в интерфейсе показываются инициалы
