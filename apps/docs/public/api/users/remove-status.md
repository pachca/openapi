...
> Краткое содержание: Снимает статус с другого сотрудника вместе с режимом «Нет на месте» и его текстом
...
Если статуса не было, ответ всё равно `204`. Свой статус снимает [Удаление своего статуса](/api/profile/delete-status).
