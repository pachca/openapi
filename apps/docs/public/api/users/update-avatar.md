...
> Краткое содержание: Ставит или заменяет аватар другому сотруднику
...
Свой аватар ставят методом [Загрузка своего аватара](/api/profile/update-avatar) — он доступен всем ролям и ботам.
