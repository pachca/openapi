...
> Краткое содержание: Показывает пользователю модальное окно с формой в ответ на его действие
