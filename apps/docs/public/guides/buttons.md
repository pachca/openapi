...
Для обработки Data-кнопок включите вебхук на вкладке **Исходящий вебхук** в карточке бота, указав URL своего сервера, и отметьте событие **Нажатие кнопок**. Подробнее — в разделе [Исходящие вебхуки](/guides/webhook/overview).
