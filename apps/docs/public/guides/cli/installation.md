> Расположение: CLI
> Краткое содержание: Установка @pachca/cli: глобально через npm или без установки через npx (для агентов и CI). Автодополнение, настройки по умолчанию, диагностика и обновление.
...
# ✔ CLI            v2026.8.3 (актуальная версия)
```
