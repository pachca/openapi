...
**Если подключаете агента** — используйте `npx @pachca/cli`: без установки и без шага «настрой окружение». Агент запускает команду сразу, всегда последняя версия, ничего не нужно поддерживать на машине.
