...
- [Команды](/guides/cli/commands) — каждый метод API — типизированная команда; полный справочник
...
- [Прямые запросы](/guides/cli/api-requests) — вспомогательный `pachca api`, когда команды не хватает
