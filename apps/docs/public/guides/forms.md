...
- Затем [приложение формирует представление и отправляет его](/guides/forms/handling#открытие-представления), а пользователю отображается модальное окно;
- Далее пользователь заполняет [блоки представления](/guides/forms/blocks) и [вашему приложению отправляется исходящий вебхук](/guides/forms/handling#получение-результатов) с данными заполненных пользователем полей в представлении;
- В ответе на вебхук ваше приложение может [отправить список ошибок](/guides/forms/handling#отображение-ошибок), которые необходимо отобразить пользователю в представлении, или ответить кодом 200 (после чего модальное окно будет [закрыто](/guides/forms/handling#закрытие-представления)).
...
- [Блоки представления](/guides/forms/blocks) — 10 типов блоков для построения форм
- [Обработка форм](/guides/forms/handling) — открытие, получение результатов, валидация и ошибки
