...
| 10 | [Bot](#bot) | 6 | Боты: создание, получение, редактирование, вебхук, события | |
...
Боты: создание, получение, редактирование, саморегистрация вебхука, история и удаление событий.
...
| Операция | API |
|----------|-----|
| Create | [Unfurl (разворачивание ссылок)](POST /messages/{id}/link_previews) |
...
| Операция | API |
|----------|-----|
| Create | [Экспорт сообщений](POST /chats/exports) |
| Get | [Скачать архив экспорта](GET /chats/exports/{id}) |
