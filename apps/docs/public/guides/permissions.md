...
- **Закрытые беседы и каналы, где токен не участник, не отдаёт ни один метод** — включая токен Владельца пространства. Для них доступен только состав участников, если идентификатор чата уже известен.
