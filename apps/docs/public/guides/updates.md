...
Появилась новая страница [Сценарии](/guides/workflows) — пошаговые инструкции для типичных задач с API. Каждый сценарий описывает, какие методы вызывать и в каком порядке, с учётом неочевидных ограничений.

Сценарии доступны в трёх форматах:

- **Справочник** — страница с поиском и фильтрацией по категориям
- **AI-агенты** — входят в [Agent Skills](/guides/ai-agents#agent-skills) для подключения к 40+ AI-агентам
- **CLI** — доступны через команду `pachca guide` в [терминале](/guides/cli#stsenarii)
