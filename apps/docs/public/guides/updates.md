...
В модель статуса добавлено новое поле `is_away` — режим «Нет на месте». Поле доступно как при установке своего статуса, так и при управлении статусами других сотрудников. Также добавлены новые методы для администраторов и владельцев, позволяющие просматривать, устанавливать и удалять статус любого сотрудника.
