...
Вебхук отправляется при нажатии `Data`-кнопки в сообщении от бота. После получения вы можете [отредактировать сообщение](/api/messages/update) — например, изменить или удалить кнопки — или [отправить новое](/api/messages/create) как ответ пользователю. Подробнее — в разделе [Кнопки в сообщениях](/guides/buttons).
