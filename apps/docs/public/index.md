...
- [CLI](/guides/cli) — Управление Пачкой из терминала — все API-методы одной командой
- [SDK](/guides/sdk) — Официальные SDK для TypeScript, Python, Go, Kotlin и Swift — типизированные клиенты для всех методов API
- [Сценарии](/guides/workflows) — Пошаговые сценарии для типичных задач с API
- [Исходящий Webhook](/guides/webhook) — Получение уведомлений о событиях в реальном времени
- [Авторизация](/guides/authorization) — Типы токенов, скоупы и настройка доступа к API
- [Запросы и ответы](/guides/requests-responses) — Формат запросов и ответов, тестирование API
- [Ошибки и лимиты](/guides/errors) — Коды ошибок HTTP и rate limits
- [Экспорт сообщений](/guides/export) — Экспорт сообщений из чатов: запрос, скачивание и структура архива
- [Формы](/guides/forms) — Модальные формы ботов: поля ввода, жизненный цикл и валидация
- [DLP-система](/guides/dlp) — Создание правил DLP: условия, контексты и действия
- [Журнал аудита событий](/guides/audit-events) — Журнал аудита: типы событий, фильтрация и примеры запросов


## Методы API

- [Общие методы](/common/request-export) — Экспорт и загрузка файлов
- [Профиль и статус](/profile/get-info) — Информация о текущем пользователе
...
- [Формы](/views/open) — Модальные окна с полями ввода
...
> Документация по работе с методом разворачивания ссылок доступна в разделе
  [Unfurl (разворачивание ссылок)](/link-previews/add)
