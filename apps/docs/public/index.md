...
- [Авторизация](/guides/authorization) — OAuth 2.0 токены, скоупы и ролевые ограничения
- [Запросы и ответы](/guides/requests-responses) — Формат запросов, пагинация, тестирование
