...
В [n8n Node 2.0.5](/guides/n8n/overview) исправлена ошибка 403 в Pachca Trigger при использовании бот-токенов — добавлен параметр **Webhook Setup** с ручным (по умолчанию) и автоматическим режимами. Ручной режим работает с любым типом токена. Автоматический регистрирует и очищает webhook URL через API при активации и деактивации workflow.
