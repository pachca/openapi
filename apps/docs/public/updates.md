...
- `pachca threads list` — список тредов с фильтрами `--last-message-at-after` / `--last-message-at-before`, курсорной пагинацией и сортировкой по убыванию времени последнего сообщения
