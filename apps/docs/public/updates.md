...
- **Формы** — визуальный конструктор, шаблоны и JSON-режим
- **AI Tool Use** — использование узлов как инструментов AI Agent
- **Полная обратная совместимость** — все существующие workflow на v1 продолжают работать без изменений

Подробнее о [миграции с v1](/guides/n8n/migration) и [устранении ошибок](/guides/n8n/troubleshooting).
