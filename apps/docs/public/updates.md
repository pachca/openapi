...
Заодно документация CLI переработана и разбита на разделы с понятной прогрессией от терминала к агентам. Подробнее — [Запросы к API](/guides/cli/api-requests) и [AI агенты](/guides/ai-agents); полный справочник — [Команды](/guides/cli/commands).
