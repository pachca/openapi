...
export const chatOperations: INodeProperties[] = [
	{
		...
		options: [
			...
			{
				name: 'Get Many Workspace Chats',
				value: 'getAllCompanyChats',
...
{ name: 'Public', value: 'public', description: 'All public chats in the workspace, regardless of user membership' }],
	...
	{
		displayName: 'Requires owner role and the "Corporation" plan',
		name: 'chatGetAllCompanyChatsNotice',
		type: 'notice',
		default: '',
		displayOptions: { show: { resource: ['chat'], operation: ['getAllCompanyChats'] } },
	},
	{
		displayName: 'Return All',
		name: 'returnAll',
	...
	},
	{
		...
		description: 'Max number of results to return',
		typeOptions: { minValue: 1, maxValue: 50 },
		displayOptions: { show: { resource: ['chat'], operation: ['getAllCompanyChats'], returnAll: [false] } },
	},
	{
		displayName: 'Simplify',
		name: 'simplify',
	...
	},
	{
		...
		name: 'activity',
		type: 'options',
		options: [{ name: 'Active', value: 'active', description: 'Active chats only' },
{ name: 'Archived', value: 'archived', description: 'Archived chats only' }],
		default: "",
