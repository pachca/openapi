...
export const formFields: INodeProperties[] = [
	...
	},
	{
		...
		type: 'options',
		options: [
			{ name: 'Template', value: 'template', displayOptions: { show: { '@version': [1] } } },
			{ name: 'Visual Builder', value: 'builder' },
			{ name: 'JSON', value: 'json' },
		],
		default: 'builder',
		description: 'Build form visually, use a template, or paste JSON',
		displayOptions: { show: { resource: ['form'], operation: ['create'] } },
	},
	{
		...
		type: 'options',
		options: [
			{ name: 'Access Request (V1)', value: 'access_request', description: 'Access request form' },
			{ name: 'Bug Report', value: 'bug_report', description: 'Bug report with severity and screenshots' },
			{ name: 'Feedback', value: 'feedback', description: 'Collect user feedback with rating' },
			{ name: 'Feedback Form (V1)', value: 'feedback_form', description: 'Feedback form' },
			{ name: 'Survey', value: 'survey', description: 'Multi-question survey with radio and checkboxes' },
			{ name: 'Survey Form (V1)', value: 'survey_form', description: 'Survey form' },
			{ name: 'Task Request (V1)', value: 'task_request', description: 'Task creation form' },
			{ name: 'Time Off Request', value: 'timeoff', description: 'Vacation request with dates and documents' },
			{ name: 'Time-Off Request (V1)', value: 'timeoff_request', description: 'Time-off request form' },
		],
		default: 'feedback',
		description: 'Select a predefined form template',
		displayOptions: { show: { resource: ['form'], operation: ['create'], formBuilderMode: ['template'] } },
	},
	{
	...
	{
		displayName: 'This operation is deprecated. In v2, form templates are available directly in the Visual Builder mode when creating a form.',
		name: 'getTemplatesNotice',
		type: 'notice',
		default: '',
		displayOptions: { show: { resource: ['form'], operation: ['getTemplates'] } },
	},
];