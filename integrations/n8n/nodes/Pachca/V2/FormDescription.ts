...
export const formOperations: INodeProperties[] = [
	{
		...
		options: [
			...
			},
			{
				...
				action: 'Respond to a form submission',
			},
		],
		default: 'create',
	},
...
export const formFields: INodeProperties[] = [
	...
	},
	{
		...
		required: true,
		default: '',
		displayOptions: { show: { resource: ['form'], operation: ['submitResponse'] } },
	},
	{
		...
		options: [
			{
				...
				type: 'json',
				default: "{}",
				description: 'Field validation errors. Key — block `name`, value — the error text shown under the field. Without this field the view closes as successfully submitted.',
				placeholder: '{"date_end":"The end date of the leave cannot be earlier than the start date"}',
			},
		],
	},
];