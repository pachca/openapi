	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				placeholder: '2025-05-02T09:11:00.000Z',
			},
			{
...
{ name: 'Bot Deleted', value: 'bot_deleted' },
{ name: 'Bot OAuth Client Updated', value: 'bot_oauth_client_updated', description: 'Bot OAuth client settings changed' },
{ name: 'Bot Scopes Updated', value: 'bot_scopes_updated', description: 'Bot token scopes changed' },
{ name: 'Bot Token Recreated', value: 'bot_token_recreated', description: 'Bot token recreated (rotation)' },
{ name: 'Bot Webhook Settings Updated', value: 'bot_webhook_settings_updated', description: 'Bot outgoing webhook settings changed' },
...
{ name: 'Exchange Disabled', value: 'exchange_disabled', description: 'Exchange integration disabled' },
...
{ name: 'OAuth Authorization Granted', value: 'oauth_authorization_granted', description: 'User granted an OAuth client access to their data' },
{ name: 'OAuth Authorization Revoked', value: 'oauth_authorization_revoked', description: 'An OAuth client\'s access to user data was revoked' },
{ name: 'OAuth Device Authorization Approved', value: 'oauth_device_authorization_approved', description: 'Employee confirmed an app sign-in from a device' },
{ name: 'OAuth Device Authorization Denied', value: 'oauth_device_authorization_denied', description: 'Employee rejected an app sign-in from a device' },
...
{ name: 'Video Call Finished', value: 'video_call_finished' },
{ name: 'Video Call Recording Ready', value: 'video_call_recording_ready' },
{ name: 'Video Call Started', value: 'video_call_started' }],
				default: "",
			...
			},
			{
				...
				placeholder: '2025-05-01T09:11:00.000Z',
			},
		],
	},
];