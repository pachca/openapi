...
- **Добавлено** (api): Самоописание API: `pachca api ls` (список всех эндпоинтов), `pachca api <МЕТОД> <путь> --describe|--spec|--docs` — CLI описывает API против собственной спецификации (для агентов: не нужно грузить документацию в контекст)
