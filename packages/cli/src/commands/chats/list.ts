...
export default class ChatsList extends BaseCommand {
  ...
  static override examples = [
      ...
      "Создать гостя в чат — Выбери активный чат, в который добавить гостя — узнай его ID:\n  $ pachca chats list"
  ];
  ...
  static override flags = {
    ...
    'archived': Flags.boolean({
      description: "Добавляет к выдаче архивные чаты. По умолчанию возвращаются только активные. Работает при любом значении `availability`. Значение, отличное от `true`, `false`, `1` и `0`, фильтр не применяет.",
      default: false,
      allowNo: true,
    }),
