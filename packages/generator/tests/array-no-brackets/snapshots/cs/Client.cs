...
public class SearchService
{
    ...
    public virtual async System.Threading.Tasks.Task<List<MessageResult>> SearchMessagesAllAsync(
        string query,
        List<int> chatIds,
        List<int>? userIds = null,
        int? limit = null,
...
public sealed class SearchServiceImpl : SearchService
{
    ...
    public override async System.Threading.Tasks.Task<List<MessageResult>> SearchMessagesAllAsync(
        string query,
        List<int> chatIds,
        List<int>? userIds = null,
        int? limit = null,
