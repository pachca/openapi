...
val startTime : java.time.OffsetDateTime = 2025-05-01T09:11:00Z // java.time.OffsetDateTime | Начальная метка времени (включительно)
val endTime : java.time.OffsetDateTime = 2025-05-02T09:11:00Z // java.time.OffsetDateTime | Конечная метка времени (исключительно)
val eventKey : AuditEventKey = user_login // AuditEventKey | Фильтр по конкретному типу события
val actorId : kotlin.String = 98765 // kotlin.String | Идентификатор пользователя, выполнившего действие
val actorType : kotlin.String = User // kotlin.String | Тип актора
val entityId : kotlin.String = 98765 // kotlin.String | Идентификатор затронутой сущности
val entityType : kotlin.String = User // kotlin.String | Тип сущности
val limit : kotlin.Int = 1 // kotlin.Int | Количество записей для возврата
...
| **actorId** | **kotlin.String**| Идентификатор пользователя, выполнившего действие | [optional] |
| **actorType** | **kotlin.String**| Тип актора | [optional] |
| **entityId** | **kotlin.String**| Идентификатор затронутой сущности | [optional] |
