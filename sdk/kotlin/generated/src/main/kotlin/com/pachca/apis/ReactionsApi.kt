...
import com.pachca.models.ListReactions200Response
import com.pachca.models.OAuthError
import com.pachca.models.Reaction
import com.pachca.models.ReactionRequest
...
import io.ktor.http.ParametersBuilder
    ...
    httpClientConfig: ((HttpClientConfig<*>) -> Unit)? = null,
        ...
        */
        ...
        open suspend fun addReaction(id: kotlin.Int, reactionRequest: ReactionRequest): HttpResponse<Reaction> {
        ...
        * Список реакций  Метод для получения актуального списка реакций на сообщение.
         ...
         * @return ListReactions200Response
        */
            @Suppress("UNCHECKED_CAST")
        open suspend fun listReactions(id: kotlin.Int, limit: kotlin.Int?, cursor: kotlin.String?): HttpResponse<ListReactions200Response> {
        ...
        * Удаление реакции  Метод для удаления реакции на сообщение.  Для удаления реакции вам необходимо знать &#x60;id&#x60; сообщения и указать его в &#x60;URL&#x60; запроса. Реакции на сообщения хранятся в виде символов &#x60;Emoji&#x60;.  Удалять можно только те реакции, которые были поставлены авторизованным пользователем.
         ...
         * @return void
        */
        open suspend fun removeReaction(id: kotlin.Int, code: kotlin.String, name: kotlin.String?): HttpResponse<Unit> {
