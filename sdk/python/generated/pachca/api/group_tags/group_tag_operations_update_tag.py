...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> ApiError | GroupTagOperationsUpdateTagResponse200 | OAuthError | None:
    if response.status_code == 200:
        response_200 = GroupTagOperationsUpdateTagResponse200.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[ApiError | GroupTagOperationsUpdateTagResponse200 | OAuthError]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ApiError | GroupTagOperationsUpdateTagResponse200 | OAuthError
     """
