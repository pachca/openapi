...
def _get_kwargs(
    *,
    ...
    chat_subtype: ChatSubtype | Unset = UNSET,
    ...
    json_chat_subtype: str | Unset = UNSET
    if not isinstance(chat_subtype, Unset):
        json_chat_subtype = chat_subtype.value

    params["chat_subtype"] = json_chat_subtype
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> ApiError | OAuthError | SearchOperationsSearchChatsResponse200 | None:
    if response.status_code == 200:
        response_200 = SearchOperationsSearchChatsResponse200.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[ApiError | OAuthError | SearchOperationsSearchChatsResponse200]:
    return Response(
...
) -> Response[ApiError | OAuthError | SearchOperationsSearchChatsResponse200]:
    """  Поиск чатов
...
def sync(
    *,
...
) -> ApiError | OAuthError | SearchOperationsSearchChatsResponse200 | None:
    """  Поиск чатов
    ...
    Returns:
        ApiError | OAuthError | SearchOperationsSearchChatsResponse200
     """
