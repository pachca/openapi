...
def sync_detailed(
    *,
    ...
    Чтобы открыть модальное окно с представлением, ваше приложение должно иметь действительный,
    неистекший `trigger_id`.

    Args:
        body (OpenViewRequest): Запрос на открытие представления
