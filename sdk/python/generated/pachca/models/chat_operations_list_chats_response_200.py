...
T = TypeVar("T", bound="ChatOperationsListChatsResponse200")



@_attrs_define
class ChatOperationsListChatsResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        chat_operations_list_chats_response_200 = cls(
            data=data,
            meta=meta,
        )


        chat_operations_list_chats_response_200.additional_properties = d
        return chat_operations_list_chats_response_200
