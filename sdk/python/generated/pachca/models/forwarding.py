...
class Forwarding:
    """ Информация о пересланном сообщении
        ...
        Attributes:
            original_message_id (int): Идентификатор оригинального сообщения
            original_chat_id (int): Идентификатор чата, в котором находится оригинальное сообщение
            author_id (int): Идентификатор пользователя, создавшего оригинальное сообщение
