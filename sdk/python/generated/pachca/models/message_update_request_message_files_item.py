...
T = TypeVar("T", bound="MessageUpdateRequestMessageFilesItem")



@_attrs_define
class MessageUpdateRequestMessageFilesItem:
    """ 
        Attributes:
            ...
            file_type (str | Unset): Тип файла: файл (file), изображение (image) Example: image.
            size (int | Unset): Размер файла в байтах, отображаемый пользователю Example: 12345.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        message_update_request_message_files_item = cls(
            key=key,
            name=name,
            file_type=file_type,
            size=size,
        ...
        message_update_request_message_files_item.additional_properties = d
        return message_update_request_message_files_item
