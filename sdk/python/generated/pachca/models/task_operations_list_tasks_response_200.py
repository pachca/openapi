...
T = TypeVar("T", bound="TaskOperationsListTasksResponse200")



@_attrs_define
class TaskOperationsListTasksResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        task_operations_list_tasks_response_200 = cls(
            data=data,
            meta=meta,
        )


        task_operations_list_tasks_response_200.additional_properties = d
        return task_operations_list_tasks_response_200
