...
T = TypeVar("T", bound="UserOperationsListUsersResponse200")



@_attrs_define
class UserOperationsListUsersResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_operations_list_users_response_200 = cls(
            data=data,
            meta=meta,
        )


        user_operations_list_users_response_200.additional_properties = d
        return user_operations_list_users_response_200
