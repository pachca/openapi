...
from ..models.view_block_checkbox_type import ViewBlockCheckboxType
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="ViewBlockCheckbox")
...
class ViewBlockCheckbox:
    """ Блок checkbox — чекбоксы
        ...
        Attributes:
            type_ (ViewBlockCheckboxType): Тип блока Example: checkbox.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        view_block_checkbox.additional_properties = d
        return view_block_checkbox
