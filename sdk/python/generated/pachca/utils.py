...
# Unions the spec discriminates by a literal field: {union: (field, {value: member})}.
# Unions absent here have no discriminator and are matched by payload shape.
_UNION_DISCRIMINATORS: dict[object, tuple[str, dict[str, type]]] = {
    ViewBlockUnion: ("type", {"header": ViewBlockHeader, "plain_text": ViewBlockPlainText, "markdown": ViewBlockMarkdown, "divider": ViewBlockDivider, "input": ViewBlockInput, "select": ViewBlockSelect, "radio": ViewBlockRadio, "checkbox": ViewBlockCheckbox, "date": ViewBlockDate, "time": ViewBlockTime, "file_input": ViewBlockFileInput}),
}
