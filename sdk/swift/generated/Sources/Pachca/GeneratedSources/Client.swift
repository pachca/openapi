...
public struct CommonService {
    ...
    public func uploadFile(request body: FileUploadRequest) async throws -> Void {
        ...
        appendField("contentDisposition", String(describing: body.contentDisposition))
        appendField("acl", String(describing: body.acl))
        appendField("policy", String(describing: body.policy))
        appendField("xAmzCredential", String(describing: body.xAmzCredential))
        appendField("xAmzAlgorithm", String(describing: body.xAmzAlgorithm))
        appendField("xAmzDate", String(describing: body.xAmzDate))
        appendField("xAmzSignature", String(describing: body.xAmzSignature))
