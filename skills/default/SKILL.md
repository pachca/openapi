...
name: pachca-api
description: >
  REST API мессенджера Пачка. Управление сообщениями, чатами,
  пользователями, ботами, задачами и безопасностью.
  Используй этот скилл как точку входа для выбора нужного скилла.
---
