# Чаты и участники — Справочник эндпоинтов
...
- `chatId` (path, integer, **обязательный**): Идентификатор чата
...
- `chatId` (path, integer, **обязательный**): Идентификатор чата
- `tagId` (path, integer, **обязательный**): Идентификатор тега
...
- `chatId` (path, integer, **обязательный**): Идентификатор чата
- `userId` (path, integer, **обязательный**): Идентификатор пользователя
